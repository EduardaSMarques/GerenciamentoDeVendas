...
public class Dado {
		...
		public void preenchendoComDadosAleatorios() {
				for(int i = 0; i < 6; i++) {
					...
					capas[i] = new Capa((i+1)*112233, "Capa"+i, (i+1)*50.00, "material"+i, "cor"+i, 
									"textura"+i, "modelo"+i, "descricao"+i, "categoria"+i);
					carregadores[i] = new Carregador((i+1)*113322, "carregador"+i, (i+1)*50.00,
					...
					peliculas[i] = new Pelicula((i+1)*223311, "Pelicula"+i, (i+1)*50.00, "material"+i, "textura"+i, 
										"modelo"+i, "descricao"+i, "categoria"+i);
					suportes[i] = new Suporte((i+1)*332211, "Suporte"+i, (i+1)*50.00, "material"+i, "cor"+i, "textura"+i, 
										"tipoDoSuporte"+i, "tamanho"+i, "modelo"+i, "descricao"+i, "categoria"+i);
					estoques[i] = new Estoque("Produto"+i, (i+1)*20, (i+1)*50);
					...
					contas[i] = new Conta("Conta"+i, "descricao"+i, (i+1)*5, (i+1)*50.00, "dia"+i, "mês"+i, "ano"+i,"status"+i);
